 ...
 */
$config['site_title']                 = "badminton";       // Site Title, example.com
...
$config['error_start_delimiter']   = '<p><div class="alert alert-danger alert-dismissable">';		// Error message start delimiter
$config['error_end_delimiter']     = '</div></p>';	// Error message end delimiter
